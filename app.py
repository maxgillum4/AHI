...
const CONFIG = {
    ...
    stages: [
        { 
            ...
            min: 0.0,
            max: 2.19,
            blurb: "Foundational stage. AI interest is isolated. You lack the consistent data readiness and ownership needed to scale."
        },
        { 
            name: "Exploring",
            min: 2.2,
            max: 3.19,
            blurb: "Initial practices are emerging. Scale requires tighter alignment across business and tech units."
        },
        { 
            name: "Established",
            min: 3.2,
            max: 4.19,
            blurb: "Standardized stage. You have clear capability. Focus on scaling your operating model and tracking ROI."
        },
        { 
            name: "Leading",
            min: 4.2,
            max: 5.0,
            blurb: "Advanced stage. AI is a core strategic lever. Predictive decisioning and automated governance are primary goals."
        }
    ],

    // ✅ CRITICAL FIX:
    // Uses the same server that served this page
    PHASE1_API_BASE: window.location.origin
};
